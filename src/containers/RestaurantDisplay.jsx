  ...
  const fetchRestaurants = async () => {
    try {
      ...
      const response = await fetch('/restaurant', {
        ...
        body: JSON.stringify({ zipcode: location, radius: meters }),
      });
        ...
        <div>
          ...
          <div>
            <div>
              ...
              >
                <MenuItem value={5} onClick={milesToMeters}>
                  5 Miles
                </MenuItem>
                <MenuItem value={10} onClick={milesToMeters}>
                  10 Miles
                </MenuItem>
                <MenuItem value={15} onClick={milesToMeters}>
                  15 Miles
                </MenuItem>
                <MenuItem value={20} onClick={milesToMeters}>
                  20 Miles
                </MenuItem>
                <MenuItem value={25} onClick={milesToMeters}>
                  25 Miles
                </MenuItem>
              </Menu>
            </div>
